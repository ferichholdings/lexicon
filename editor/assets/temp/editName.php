                ...
                <form id ="editNameForm" class="bordered">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bordered" id="Name" name="Name" value ="<?php echo htmlentities($admin->getNameDetailsById($nameId)["name"] ); ?>" placeholder="Pesron's Name" required />
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bordered" id="otherForms" name="otherForms" value ="<?php echo htmlentities($admin->getNameDetailsById($nameId)["otherForms"] ); ?>" placeholder="Other forms of the name" required />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bordered" id="nameUsage" name="nameUsage" value ="<?php echo htmlentities($admin->getNameDetailsById($nameId)["nameUsage"] ); ?>" placeholder="Pesron's Name" required />
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control bordered" id="origin" name="origin" value ="<?php echo htmlentities($admin->getNameDetailsById($nameId)["origin"] ); ?>" placeholder="What is the origin of this name ?" required />
                        </div>
                        <div class="form-group col-md-6">
                            <label for="pronounce">Pronunciation</label>
                            <input type="text" class="form-control bordered" id="pronounce" name="pronounce" value ="<?php echo htmlentities($admin->getNameDetailsById($nameId)["pronounce"] ); ?>" placeholder="How is this name pronounced ?"  required />
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control bordered" rows ="30" style ="height:150px !important;text-align:left;" id="history" name="history" placeholder="What is the history of this name ?" requied>
                                 <?php echo htmlentities($admin->getNameDetailsById($nameId)["history"] ); ?>
                            </textarea>
                        </div>
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control bordered" rows ="30" style ="height:150px !important;text-align:left;" id="meaning" name="meaning" placeholder="What is the meaning of this name ?" required>
                              <?php echo htmlentities($admin->getNameDetailsById($nameId)["meaning"] ); ?>
                            </textarea>
                        </div>
                    ...
                    <input type="hidden" name="nId" value="<?php echo $nameId; ?>" />
...
<script>
  let gender = "<?php echo $admin->getNameDetailsById($nameId)["gender"]; ?>";
