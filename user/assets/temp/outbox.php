    ...
    <div class="col-md-4 message-sideleft">
        <div class="panel">
            <div class="panel-heading">
                <div class="pull-left"> <h5 class="panel-title mx-2 p-2"> Outbox </h5>  </div>
                <div class="pull-right p-2">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class ="mx-2 text-primary border-bottom" ><a class ="text-primary" href="?pg=outbox.php"><i class="fa fa-upload"></i>   Outbox</a></li>
