...
<div class="col-md-12"> 
		<div class="row mt-4 border-bottom"> 
			<div class="col-md-5"> <h2><b> Pending Names </b></h2></div>  
...
<div class="col-md-12"> 
		<div class="row mt-4 border-bottom"> 
			<div class="col-md-5"> <h2><b> Waiting Names </b></h2></div>  
	...
	<table class="table table-striped table-hover" id ="waitingNames">
		<thead>
			<tr>
				<th> <span class="custom-checkbox"> <input type="checkbox" id="selectAll"> <label for="selectAll"></label> </span> </th>
				<th>Name</th>
...
<!-- Modal  viewing names details and assigning LEXIPOINTS -->
...
$(document).ready(function() {
    $('#newlyAddedNames, #waitingNames').DataTable( {
        "dom": '<"toolbar">frtip'
    } );
