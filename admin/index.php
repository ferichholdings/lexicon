...
<html lang="en">
  <head>
  	<title>Names Lexicon ~ admin</title>
    <meta charset="utf-8">
		...
		<div class="wrapper d-flex align-items-stretch">
		   ...
		   <div class="p-4">
	        ...
	        <ul class="list-unstyled components mb-5">
			  ...
			  <li class="border-bottom lexiMenu"> <a href="./?pg=addName"><span class="fa fa-plus mr-3"></span>     Add New Name   </a> </li>
			  <li class="border-bottom lexiMenu"> <a href="./?pg=viewAllNames"><span class="fa fa-eye mr-3"></span> View All Names </a> </li>
			  <li class="border-bottom lexiMenu"> <a href="./?pg=viewNames"><span class="fa fa-eye mr-3"></span>    View My Names  </a> </li>
 ...
 <style>
	...
	.modal .modal-dialog-aside_2{  width: 400px; max-width:80%; height: 100%; margin:0;transform: translate(0); transition: transform .2s;  }	 
	.modal .modal-dialog-aside_2 .modal-content{  height: inherit; border:0; border-radius: 0;}
	.modal .modal-dialog-aside_2 .modal-content .modal-body{ overflow-y: auto }
	.modal.fixed-left .modal-dialog-aside_2{ margin-left:auto;  transform: translateX(100%); }
	.modal.fixed-right .modal-dialog-aside_2{ margin-right:auto; transform: translateX(-100%); }
	.modal.show .modal-dialog-aside_2{ transform: translateX(0);  } 	
</style>
      ...
      <div class="modal-header">
		...
		<div class="modal-body">
				<form id ="sendMessageForm">
						...
						<input type="hidden" name="receiverId" id ="rec_Id" value ="">
...
<!-- <div id="modal_aside_right_2" class="modal fixed-left fade" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-aside_2" role="document">
    <div class="modal-content">
      <div class="modal-header">
		<h6 class="modal-title">Approving <small id="nameHelp"> Name to be approved </small></h6>
		...
		<div class="modal-body mt-2"> 
					<ul class="list-group">
						<li class="list-group-item">Name                    (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Other forms of the name (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Gender          		(0.5 LP)   <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Origin                  (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">History                 (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Meaning                 (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Pronunciation           (1 LP)     <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
						<li class="list-group-item">Usage                   (0.5 LP)   <span class="approveLexipoint float-right"><i class="fa fa-check btn-sm btn-primary" style="width:30px; cursor:pointer;"></i> </li>
