...
INSERT INTO `contact` (`conId`, `name`, `email`, `subject`, `message`, `createdAt`) VALUES
(1, 'Ejiroghene Gbenedio', 'ejiro4@hotmail.com', 'Domian &amp; Hosting  Payments', 'Type your messagesdsddsdasdsdsdasdasdsa', '2020-12-18 12:51:41'),
(2, 'nnaDid Didigwu', 'nnadidsuc@gmail.com', 'Site cannot be reached', 'kkskddjsldjladjalsdsdsdas', '2020-12-18 12:53:16'),
(3, 'nnaDid Didigwu', 'nnadidsuc@gmail.com', 'Domian &amp; Hosting  Payments', 'Type your messagedssas', '2020-12-18 12:53:47'),
(4, 'nnaDid Didigwu', 'nnadidsuc@gmail.com', 'ddssdasdsdasd', 'Type your messagesdsdsadsadadas', '2020-12-18 12:53:58'),
(5, 'Mr John', 'johna@yahoo.com', 'Nameslexicon Info', 'I am here to find out some information about your', '2020-12-19 11:42:57');
...
CREATE TABLE `lexipoints` (
  ...
  `memId` int(11) NOT NULL COMMENT '\r\nID of the user who added the name taken from names table',
  `namesId` int(11) NOT NULL COMMENT 'the id of the name from names table',
  `adminId` int(10) DEFAULT NULL COMMENT 'ADMIN WHO worked on or is working on this name',
  `name` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awaded to name added',
  `gender` float NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to gender',
  `n_usage` float NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to USAGE',
  `origin` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to ORIGIN',
  `history` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to HISTORY',
  `meaning` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to MEANING',
  `pronounce` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to PRONUNCIATION',
  `otherForms` int(1) NOT NULL DEFAULT 0 COMMENT 'lexipoints awarded to OTHERFORMS ',
  `work_status` enum('in-progress','completed') NOT NULL DEFAULT 'in-progress' COMMENT 'status that shows whether a name has been worked on or is still in progress',
  `updatedAt` datetime DEFAULT NULL COMMENT 'The last  time this record was updated'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lexipoints` (`lexp_id`, `memId`, `namesId`, `adminId`, `name`, `gender`, `n_usage`, `origin`, `history`, `meaning`, `pronounce`, `otherForms`, `work_status`, `updatedAt`) VALUES
(6, 109, 88, 2, 1, 0.5, 0.5, 1, 1, 1, 1, 1, 'in-progress', '2020-12-12 11:28:26'),
(8, 105, 94, 2, 1, 0.5, 0.5, 1, 0, 1, 0, 0, 'in-progress', '2020-12-12 11:43:40'),
(9, 105, 95, 2, 1, 0.5, 0.5, 1, 1, 1, 1, 1, 'completed', '2020-12-19 12:17:04'),
(10, 103, 63, 2, 0, 0.5, 0, 1, 1, 1, 1, 1, 'in-progress', '2020-12-15 15:58:46'),
(12, 2, 60, 2, 0, 0, 0, 0, 0, 0, 0, 0, 'in-progress', NULL);
...
(43, 1, 2, 'I wish to let you know that the codes I lost last time as a result of system recovery to a point is fully recovered', 'I have successfully recovered the code after all', 0, '1', '2020-12-09 18:09:43', '2020-12-18 10:55:54'),
...
(67, 2, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', '', 45, '1', '2020-12-10 14:52:57', '2020-12-18 09:07:36'),
(68, 2, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', '', 45, '1', '2020-12-10 14:52:57', '2020-12-18 09:07:45'),
(69, 2, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', '', 43, '1', '2020-12-10 14:53:33', '2020-12-18 10:54:27'),
(71, 2, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', '', 43, '1', '2020-12-10 14:53:33', '2020-12-18 10:54:29'),
...
(83, 105, 1, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora maxime libero reiciendis illum consequatur, eligendi explicabo mollitia tenetur illo voluptate doloribus dignissimos est temporibus eius excepturi odio. Tempora, itaque molestias.', 'I am understanding it now', 0, '1', '2020-12-17 10:22:22', '2020-12-18 10:56:40'),
(86, 105, 1, 'I am in the midst of angels and', 'hello man man', 0, '1', '2020-12-18 10:38:55', '2020-12-18 10:56:42'),
(87, 1, 0, 'I have also almost always known that the man behid the scene is the only one capable of ,,,,', '', 86, '0', '2020-12-18 10:40:50', NULL),
(88, 105, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', 'Those wo leave in glass house donot throw syones', 0, '1', '2020-12-18 10:43:37', '2020-12-18 10:56:35'),
(89, 105, 1, 'The program uses urllib to read the HTML from the data files , extract the href= vaues from the anchor tags, scan for a tag that is in a particular position relative to the first name in the list, follow that link and repeat the process a number of times and report the last name you find.', 'Those wo leave in glass house donot throw syones', 0, '1', '2020-12-18 10:43:37', '2020-12-18 10:56:36'),
(90, 1, 105, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora maxime libero reiciendis illum consequatur, eligendi explicabo mollitia tenetur illo voluptate doloribus dignissimos est temporibus eius excepturi odio. Tempora, itaque molestias.', '', 83, '0', '2020-12-18 10:52:30', NULL),
(91, 1, 105, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora maxime libero reiciendis illum consequatur, eligendi explicabo mollitia tenetur illo voluptate doloribus dignissimos est temporibus eius excepturi odio. Tempora, itaque molestias.', '', 83, '0', '2020-12-18 10:52:30', NULL),
(92, 105, 1, 'the only thing left about this is NOTHING but Deployment', '', 0, '1', '2020-12-18 11:02:35', '2020-12-19 12:35:27'),
(93, 105, 1, 'the only thing left about this is NOTHING but Deployment', '', 0, '1', '2020-12-18 11:02:35', '2020-12-18 11:08:41'),
(94, 105, 1, 'the only thing left about this is NOTHING but Deployment', '', 0, '1', '2020-12-18 11:02:35', '2020-12-18 11:08:26'),
(95, 1, 2, 'I am not in the mood to leeeeee', 'hello man man', 0, '1', '2020-12-18 11:10:01', '2020-12-18 11:10:29'),
(96, 1, 2, 'I am not in the mood to leeeeee', 'hello man man', 0, '1', '2020-12-18 11:10:02', '2020-12-18 11:10:19'),
(98, 2, 0, 'I write to let you know that i have ...', 'Please find the name you added approved', 0, '0', '2020-12-18 18:02:29', NULL),
(99, 2, 0, 'I write to let you know that i have ...', 'Please find the name you added approved', 0, '0', '2020-12-18 18:02:30', NULL),
(100, 2, 105, 'I write tomlet you know that i have approved your name', 'Name approved', 0, '0', '2020-12-18 18:13:27', NULL),
(101, 2, 105, 'I write tomlet you know that i have approved your name', 'Name approved', 0, '0', '2020-12-18 18:13:28', NULL),
(102, 105, 2, 'Ok Thanks so much . I hope you love the name!', '', 0, '1', '2020-12-18 18:16:41', '2020-12-18 18:21:10'),
(103, 105, 2, 'Ok Thanks so much . I hope you love the name!', '', 0, '1', '2020-12-18 18:18:18', '2020-12-18 18:26:36'),
(104, 105, 2, 'Mnay thanks to you. I hope you loved it', '', 101, '1', '2020-12-18 18:18:53', '2020-12-18 18:21:14'),
(105, 105, 1, 'I have just succeeded in adding an in your platform.', 'Hi Admin', 0, '1', '2020-12-19 12:03:57', '2020-12-19 12:35:26');
...
(95, 'ebenebe', 'Ebeano', 'English', 'Masculine', 'Hebrew', 'nannaana', 'Hope you are there', 'The only thing', NULL, 105, 'waiting', NULL, '0', NULL, '2020-12-12 11:57:48', NULL),
(96, 'adeola', 'Ade,Ola, Deola', 'Nigeria', 'Both', 'Africa', 'A-de-o-la', 'Wealthy crown', 'It is a name associated with royalty from the western part of Nigeria', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You have a sharp mind. You have a balanced nature. You act in a determined way. You can be uncompromising when required to co-operate.<br/>You have an ingenious mind. You love to be independent. You can be very unreliable when people least expect it. You have a compassionate heart.<br/>Your persistent personality helps you get work done faster. You like to help others. You have a studious temperament. You often indulge in melodrama to get your way.<br/>You are rational and sensible. You are an exuberant person. Smartness is one of your assets. Your clumsiness makes you prone to accidents.<br/>', 105, 'approved', 2, '0', NULL, '2020-12-18 17:44:58', '2020-12-18 17:40:56'),
(97, 'astrid', 'Astride', 'Swedish, Danish, Norwegian, French', 'Feminine', 'Old German', 'AH-strid (Swedish), AH-stree (Norwegian), A-strit (German), AS-TREED (French)', 'Astrid has been used by Norway\'s royal families for hundreds of years. Famous bearers: King Olaf I\'s mother; the Swedish wife of King', 'In Scandinavian the meaning of the name Astrid is: Godly strength. Derived from Germanic compounds meaning divine strength, or divine beauty.', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You are mentally strong. You are lucky with money which is awesome. You are an attractive person. You behave recklessly from time to time.<br/>You are very romantic at heart. Spirituality is ingrained in you. Your lively personality is your plus point. You can be easily deceived by others.<br/>Being charitable and kind comes naturally to you. You are quite easygoing in life. You are quite a sensible person. You lose your temper easily.<br/>You are a refined individual. You are polite with others. You are an inspirational person. You can act cowardly in difficult situations<br/>You have a sharp mind. You have a balanced nature. You act in a determined way. You can be uncompromising when required to co-operate.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:11:46', NULL),
(98, 'attracter', 'Nil', 'English', 'Feminine', 'Latin', 'uh-trakt', 'It means to pull, to draw in, to entice', 'from the Latin attractus.', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You are very romantic at heart. Spirituality is ingrained in you. Your lively personality is your plus point. You can be easily deceived by others.<br/>Being charitable and kind comes naturally to you. You are quite easygoing in life. You are quite a sensible person. You lose your temper easily.<br/>You are a clever person. You have a sociable nature. You are a charming person. You can be inattentive at times.<br/>You have an ingenious mind. You love to be independent. You can be very unreliable when people least expect it. You have a compassionate heart.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:14:20', NULL),
(99, 'audra', 'Audrie, Audrina, Audrey, Audry', 'English, Germanic, Italian', 'Feminine', 'Old English', 'AO-DRah', 'It means &quot;noble strength', 'Derived from the Old English Æđelþpryđ or Æthelthryth, a compound name composed of the elements æđel, æthel (noble) and þryđ, thryth (might, strength):', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You are known for your intelligence. You cherish your freedom. You are quite social and outgoing. You have a tendency to behave selfishly.<br/>You have a sharp mind. You have a balanced nature. You act in a determined way. You can be uncompromising when required to co-operate.<br/>Being charitable and kind comes naturally to you. You are quite easygoing in life. You are quite a sensible person. You lose your temper easily.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:16:49', NULL),
(100, 'augustina', 'Agustina, Augusta', 'English, Italian, Portuguese, Spanish', 'Feminine', 'Latin', 'Nill', 'Meaning of the name Augustina is: Majestic, grand', 'The feminine form of Augustus; meaning majestic dignity or venerable, originally given to female relatives of Roman emperors', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You are known for your intelligence. You cherish your freedom. You are quite social and outgoing. You have a tendency to behave selfishly.<br/>You are religious at heart. You have a strong intuition. Wisdom is your forte. You are quite cynical sometimes.<br/>You are mentally strong. You are lucky with money which is awesome. You are an attractive person. You behave recklessly from time to time.<br/>You are very romantic at heart. Spirituality is ingrained in you. Your lively personality is your plus point. You can be easily deceived by others.<br/>You are a refined individual. You are polite with others. You are an inspirational person. You can act cowardly in difficult situations<br/>Your extroverted nature does your personality wonders. You have artistic abilities. You are a deep thinker. Jealousy is a sin which you commit once in a while.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:19:36', NULL),
(101, 'ayeesha', 'Aeesha, Yiesha, Asha, Asheya', 'Arabic, Swahili Indian', 'Feminine', 'Arabic, Swahili', 'Nill', 'The meaning of Ayeesha is &quot;alive and well&quot;.', 'Ayeesha is an alternate spelling of Aisha (Arabic): also possibly means &quot;life&quot; in Swahili.', 'You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You have an inventive streak. You love your freedom and don\'t like anyone messing with it. You are indecisive and always in a dilemma. You have a beautiful aura around you.<br/>You have an ingenious mind. You love to be independent. You can be very unreliable when people least expect it. You have a compassionate heart.<br/>You are mentally strong. You are lucky with money which is awesome. You are an attractive person. You behave recklessly from time to time.<br/>You are quite efficient in your work. You are a nature loving person. You have strong business acumen. You are an egoistic person.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:26:07', NULL),
(102, 'baile', 'Bilhah, Bally', 'English, Yiddish', 'Both', 'Hebrew, Spanish', 'Nill', 'Yiddish form of the Hebrew name (בֵּיילֶע) Bilhah which means old, weak, troubled, infirm\' Also English form of Bail from the Spanish: status name for a steward or official, from Old Spanish baile, Late Latin baiulivus; cognate with English Bailey.', 'Yiddish form of the Hebrew name (בֵּיילֶע) Bilhah which means old, weak, troubled, infirm\' Also English form of Bail from the Spanish: status name for a steward or official, from Old Spanish baile, Late Latin baiulivus; cognate with English Bailey.', 'You are very friendly. You have a sensitive personality. You are a large-hearted individual. Sometimes, you get very aggressive.<br/>You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>You are a refined individual. You are polite with others. You are an inspirational person. You can act cowardly in difficult situations<br/>You are rational and sensible. You are an exuberant person. Smartness is one of your assets. Your clumsiness makes you prone to accidents.<br/>You have an ingenious mind. You love to be independent. You can be very unreliable when people least expect it. You have a compassionate heart.<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:30:44', NULL),
(103, 'bambi', 'Bina', 'Italian', 'Feminine', 'Italian, English', 'BAM-bee', 'Derived from the Italian Bambina meaning little girl. It\'s the name of a male Deer in Walt Disney cartoon based on the novel of a Swiss novelist Felix Salten.', 'Derived from the Italian Bambina meaning little girl. It\'s the name of a male Deer in Walt Disney cartoon based on the novel of a Swiss novelist Felix Salten.', 'You are very friendly. You have a sensitive personality. You are a large-hearted individual. Sometimes, you get very aggressive.<br/>You are a confident person. You are a born leader. You have an adventurous streak. At times, you can be arrogant.<br/>Your clairvoyance can surprise others. Few people are as hardworking as you are. Your self confidence is immense. You tend to act in haste without thinking.<br/>You are a refined individual. You are polite with others. You are an inspirational person. You can act cowardly in difficult situations<br/>', 2, 'approved', 2, '0', NULL, '2020-12-19 11:32:46', NULL);
...
(116, 105, 'Lexi points ~ CR-1', 'Congratulations! You have earned 1 lexipoint for adding new name. Other forms of the name Confirmed!', '0', '2020-12-19 12:17:01'),
(117, 105, 'Lexi points ~ CR-1', 'Congratulations! You have earned 1 lexipoint for adding new name. History Confirmed!', '0', '2020-12-19 12:17:03');
...
--
ALTER TABLE `lexipoints`
  MODIFY `lexp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `messages`
  MODIFY `msgId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `names`
--
ALTER TABLE `names`
  MODIFY `namesId` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT for table `notify`
--
ALTER TABLE `notify`
  MODIFY `notifyId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
COMMIT;
